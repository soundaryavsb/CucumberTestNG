...
public class AddToCartFunctions {
	@Given("User should navigate to the application for add a book to the cart")
	public void userShouldNavigateToTheApplicationForAddABookToTheCart() {
	    
	   
	}
	@Given("User should enter the {string} and {string}")
	public void userShouldEnterTheAnd(String string, String string2) {
	...
	public void userAddABookToCart() {
